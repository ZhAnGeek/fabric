...
const (
	AESKEY1   = "0123456789012345"
	AESKEY2   = "0123456789012346"
	ECDSAKEY1 = `-----BEGIN PRIVATE KEY-----
...
yUrbOhTT
-----END PRIVATE KEY-----`
	ECDSAKEY2 = `-----BEGIN PRIVATE KEY-----
MIGTAgEAMBMGByqGSM49AgEGCCqBHM9VAYItBHkwdwIBAQQgWq1JVq7Eigmc7H3m
BdXokYvpvgZybWRGPcABsPNRqwagCgYIKoEcz1UBgi2hRANCAAQ06gfjCV+j7Kos
VG6DLvhZq6fH+6ksS09THX1lyGWD1SfUYkTeXWNwJvdGj+03klUQe6HLPCgEXtQC
wNo8HIDo
-----END PRIVATE KEY-----`
